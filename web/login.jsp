...
<div class="main">
  <div class="login-form fr">
    ...
    <div class="form-bd">
      <form action="/Mystore_war_exploded/login" method="POST">
        <dl>
          <dt>用户名</dt>
        ...
        <dl>
          ...
          <dd><input type="text" name="code" class="text" size="10" style="width:58px;">
            <img src="/Mystore_war_exploded/generateimg" alt="" align="absmiddle" style="position:relative;top:-2px;"/> <a href="" style="color:#999;">看不清，换一张</a></dd>
        </dl>
        <dl>
          <dt>&nbsp;</dt>
        ...
        <dl>
          <dt>记住我</dt>
          <dd><input type="checkbox" value="记住我" class="submit" name="remember"/></dd>
        </dl>
      </form>
      <dl>
        <dt>&nbsp;</dt>
