...
<div class="main">
    <div class="login-form fr">
        ...
        <div class="form-bd">
            <form action="/Mystore_war_exploded/register" method="POST">
                <dl>
                    <dt>用户名</dt>
                ...
                <dl>
                    <dt>确认密码</dt>
                    <dd><input type="password" name="password2" class="text"/></dd>
                </dl>
                <dl>
                    <dt>邮箱</dt>
                ...
                <dl>
                    <dt>验证码</dt>
                    <dd><input type="text" name="code" class="text" size="10" style="width:58px;"> <img src="/Mystore_war_exploded/generateimg" alt="" align="absmiddle" style="position:relative;top:-2px;"/> <a href="" style="color:#999;">看不清，换一张</a></dd>
                </dl>
                <dl>
                    <dt>&nbsp;</dt>
